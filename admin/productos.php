        ...
        <div class="dash-content">
            <div class="overview">
                <div class="title">
                    ...
                    <div class="col-md-10">
                    <form>
                        <button class="button-9" role="button" formaction="addproduct.php" align="right">Añadir Producto</button>
                    </form>
                    </div>
                </div>
            ...
            <?php
            $sql = "SELECT id_producto,nombre_producto,descripcion,categoria,precio,frecuencia,Stock,imagen FROM PRODUCTO";
